...
if (!file.exists("data.zip")) {
  download.file("d396qusza40orc.cloudfront.net/rprog/data/quiz1_data.zip",
                destfile = "data.zip")
  zip::unzip("data.zip")
}
...
<b> We have loaded the data for you and stored it in a variable we named "data".</b>
...
```{r 11a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 12a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 13a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 14a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 15a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 16a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 17a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 18a,exercise = TRUE,exercise.setup = "setupA"}
...
```{r 19a,exercise = TRUE,exercise.setup = "setupA"}
...
question("What was the maximum ozone value in the month of May (i.e. Month is equal to 5)?",
  ...
  answer("97"))
```
```{r 20a,exercise = TRUE,exercise.setup = "setupA"}
